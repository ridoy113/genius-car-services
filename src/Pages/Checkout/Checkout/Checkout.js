...
const Checkout = () => {
    ...
    const handlePlaceOrder = event => {
        ...
        axios.post('https://stark-hollows-04141.herokuapp.com/order', order)
            .then(response => {
                const { data } = response;
                if (data.insertedId) {
    ...
    return (
        <div className='w-50 mx-auto'>
            ...
            <form onSubmit={handlePlaceOrder}>
                ...
                <br />
                <input className='w-100 mb-2' type="text" name="adderss" placeholder='adderss' autoCapitalize='off' required />
                <br />
